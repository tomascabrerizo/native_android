...
echo ------------------------------ 
echo Build andorid native code 
echo ------------------------------ 
rem ninja -C ./obj
cmake --build ./obj
...
rem %NDK%/toolchains\llvm\prebuilt\windows-x86_64\bin\clang -target aarch64-linux-android29 -shared -o libgame.so ./src/native/*.c
...
rem TODO: Think sysroot includes and libpaths are already define in the nkd clang compiler
